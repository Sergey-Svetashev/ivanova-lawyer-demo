        ...
        <div className="container">
          ...
          <div className="services__wrap">
            <div className="services__case services__case_01">
              ...
              <Services__item
                text="Вопросы, связанные с защитой прав потребителей:" price="от 10 000 руб"/>
              <Services__item
                text="Экономические споры:" price="от 10 000 руб"/>
            </div>
            ...
            <div className="services__case services__case_04">
              <Services__item
                text="Оспаривание административных штрафов:" price="от 10 000 руб"/>
              <Services__item
